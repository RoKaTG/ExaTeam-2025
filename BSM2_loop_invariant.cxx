/* 
    ...
    Compilation : g++ -O3 -ffast-math -funroll-loops -march=native -fopenmp BSM2_loop_invariant.cxx -o BSM2_loop_invariant
...
// Removing these from gaussian_box_muller also removes them from the loop
// Small but noticeable speedup
